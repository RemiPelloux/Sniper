...
async def run_specific_vulnerability_test(
    master_host: str, master_port: int, target_url: str
) -> None:
    """
...
async def run_comprehensive_scan_example(
    ...
    result = await run_autonomous_test(
        master_host=master_host, master_port=master_port, target_url=target_url
    )
...
async def main() -> None:
    ...
    parser.add_argument(
        "--mode",
        choices=["comprehensive", "specific"],
