...
from src.ml.autonomous_tester import AutonomousTester, VulnerabilityType, PayloadResult
...
def main():
    ...
    print("This demo showcases the autonomous testing capabilities of the Sniper toolkit")
