...
class HTMLReportRenderer:
    ...
    def _generate_category_reports(self, 
                                output_dir: str,
                                target: str,
                                scan_date: str,
                                categorized_findings: Dict[str, List[Dict[str, Any]]]) -> None:
        """
        ...
        for category, findings in categorized_findings.items():
            ...
            findings.sort(key=lambda x: severity_order.get(x.get("severity", "info").lower(), 999))
    ...
    def _generate_finding_details(self, 
                               output_dir: str,
                               target: str,
                               scan_date: str,
                               categorized_findings: Dict[str, List[Dict[str, Any]]]) -> None:
