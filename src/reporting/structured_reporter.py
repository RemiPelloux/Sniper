...
class StructuredReporter:
    ...
    def create_report_structure(self, target: str, findings: Dict[str, List[Dict[str, Any]]]) -> str:
        """
        ...
        for category, category_findings in findings.items():
            ...
            self._generate_category_report(target, category, category_findings, target_dir)
    ...
    def _generate_main_report(self, target: str, findings: Dict[str, List[Dict[str, Any]]], target_dir: str):
        """
    ...
    def _generate_category_report(self, target: str, category: str, 
                                 findings: List[Dict[str, Any]], target_dir: str):
        """
    ...
    def _categorize_findings(self, results: Dict[str, Any]) -> Dict[str, List[Dict[str, Any]]]:
        """
...
def create_structured_report(target: str, findings: Dict[str, List[Dict[str, Any]]], 
