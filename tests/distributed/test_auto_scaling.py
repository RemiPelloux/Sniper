...
from src.distributed.base import NodeInfo, NodeStatus, TaskStatus, DistributedTask, TaskPriority, NodeRole
...
class TestAutoScaler(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.auto_scaler.config.scaling_policy, ScalingPolicy.QUEUE_DEPTH)
    ...
    def test_should_apply_rule_queue_depth(self):
        ...
        self.auto_scaler.last_scale_up = datetime.now() - timedelta(seconds=20)  # Set time in the past
    ...
    def test_should_apply_rule_scaling_mode(self):
        ...
        self.assertFalse(self.auto_scaler._should_apply_rule(remove_rule, remove_metrics))
        ...
        self.assertTrue(self.auto_scaler._should_apply_rule(remove_rule, remove_metrics))
    ...
    def test_apply_scaling_action_add(self):
        ...
        with patch.object(self.auto_scaler, '_scale_up') as mock_scale_up:
            ...
            self.assertTrue((datetime.now() - self.auto_scaler.last_scale_up).total_seconds() < 1)
    ...
    def test_apply_scaling_action_remove(self):
        ...
        with patch.object(self.auto_scaler, '_scale_down') as mock_scale_down:
            ...
            self.assertTrue((datetime.now() - self.auto_scaler.last_scale_down).total_seconds() < 1)
    ...
    def test_scale_up(self):
        ...
        self.assertEqual(self.auto_scaler.node_history["worker-new-1"]["status"], "creating")
