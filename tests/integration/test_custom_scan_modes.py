...
def test_scan_with_web_api_test_mode(custom_scan_modes, mock_scan_execution):
    ...
    runner = CliRunner()
    result = runner.invoke(app, ["scan", "run", "https://api.example.com", "--mode", "web_api_test"])
...
def test_scan_with_minimal_recon_mode(custom_scan_modes, mock_scan_execution):
    ...
    runner = CliRunner()
    result = runner.invoke(app, ["scan", "run", "example.com", "--mode", "minimal_recon"])
...
def test_override_scan_mode_parameters(custom_scan_modes, mock_scan_execution):
    ...
    result = runner.invoke(app, [
        "scan", "run", "example.com", 
        "--mode", "minimal_recon",
        "--module", "web"  # Add a module not in the default set for minimal_recon
    ])
