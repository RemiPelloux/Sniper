...
class TestFeatureExtraction:
    ...
    def test_calculate_vulnerability_score(self):
        ...
        expected_score = (VULNERABILITY_WEIGHTS["sql_injection"] + 
                          VULNERABILITY_WEIGHTS["xss"]) / 2
        ...
        assert calculate_vulnerability_score(single_feature) == VULNERABILITY_WEIGHTS["path_traversal"]
...
class TestFeatureVectorization:
    ...
    def test_features_to_vector(self):
        ...
        custom_vector = features_to_vector(features, ["feature2", "feature3", "feature1"])
...
class TestModelEvaluation:
    ...
    def test_evaluate_model_performance(self):
        ...
        high_threshold = evaluate_model_performance(true_labels, mixed_preds, threshold=0.7)
        assert high_threshold["true_positives"] == 1  # Only the 0.9 prediction passes threshold
...
class TestFindingFeatures:
    ...
    def test_extract_finding_features(self):
        ...
        assert features["vulnerability_weight"] == VULNERABILITY_WEIGHTS["sql_injection"]
        assert features["sql_injection_present"] == 1.0
