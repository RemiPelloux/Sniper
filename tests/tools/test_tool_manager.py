...
from tools.manager import ToolManager, ToolCategory, ToolInstallMethod
...
class TestToolManager:
    ...
    @patch('shutil.which')
    def test_tool_manager_initialization(self, mock_which, mock_system, temp_tool_dir, temp_custom_dir):
        ...
        mock_which.side_effect = lambda cmd: '/usr/bin/' + cmd if cmd in ['apt', 'pip'] else None
    ...
    @patch('platform.system')
    @patch('shutil.which')
    def test_add_custom_tool(self, mock_which, mock_system, temp_tool_dir, temp_custom_dir):
    ...
    @patch('platform.system')
    @patch('shutil.which')
    def test_get_tools_by_category(self, mock_which, mock_system, temp_tool_dir, temp_custom_dir):
